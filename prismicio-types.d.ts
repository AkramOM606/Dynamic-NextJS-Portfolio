...
export interface ContactMeSliceDefaultPrimary {
  /**
   * Sub Heading field in *ContactMe → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: contact_me.primary.sub_heading
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  ...
  /**
   * Contact Field field in *ContactMe → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: contact_me.primary.contact_field
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  contact_field: prismic.KeyTextField;

  /**
   * Contact Field Entry field in *ContactMe → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: contact_me.primary.contact_field_entry
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  contact_field_entry: prismic.RichTextField;
}
